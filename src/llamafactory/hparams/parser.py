...
_T_AND_E_ARGS = [ModelArguments, DataArguments, TrainingArguments, FinetuningArguments, EvaluationArguments, GeneratingArguments]
_T_AND_E_CLS = tuple[ModelArguments, DataArguments, TrainingArguments, FinetuningArguments, EvaluationArguments, GeneratingArguments]
...
def get_train_and_eval_args(args: Optional[Union[Dict[str, Any], List[str]]] = None) -> _T_AND_E_CLS:
    ...
    transformers.set_seed(training_args.seed)
    return model_args, data_args, training_args, finetuning_args, eval_args, generating_args